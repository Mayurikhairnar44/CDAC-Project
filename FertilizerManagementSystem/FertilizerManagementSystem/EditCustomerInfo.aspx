                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:RegularExpressionValidator ID="RegularExpressionValidatorMobile" runat="server" ErrorMessage="मोबाइल नंबर अवैध आहे" ControlToValidate="txtContact" ValidationExpression="^[0-9]{10}$" ValidationGroup="SignUpValidationGroup"></asp:RegularExpressionValidator>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="पासवर्ड टाका" ControlToValidate="txtNewPassword" ValidationGroup="SignUpValidationGroup"> </asp:RequiredFieldValidator>
                                     <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ErrorMessage="पासवर्ड किमान 8 वर्णांचा असावा, त्यात किमान एक अप्परकेस अक्षर, एक लोअरकेस अक्षर, एक अंक आणि एक विशेष वर्ण असावा." ControlToValidate="txtNewPassword" ValidationExpression="^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[!@#$%^&*()_+])[A-Za-z\d!@#$%^&*()_+]{8,}$" ValidationGroup="SignUpValidationGroup"></asp:RegularExpressionValidator>
                                </div>
                            </div>
                        </div>
                        <div class="row">
